...
\name{}{Wallace Octavius Obey}
\address{}
\mobile{(+1) (980) 616-8287}

\email{wobey@uncc.edu}
\homepage{sites.google.com/view/wallace-obey/home  }
\github{wobey000}
%\linkedin{Almigdad Suliman}
%\skype{skypeid}
...
\makecvfooter{\today}{Wallace Obey~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
